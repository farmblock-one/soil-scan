...
export function LocationInput({ value, onChange }: Props) {
  ...
  return (
    <div>
      <label className="mb-1 block text-sm font-medium text-stone-700">Vị trí / khu vực (tùy chọn)</label>
      <div className="flex gap-2">
        ...
        <button
          ...
          disabled={locating}
          className="whitespace-nowrap rounded-lg border border-stone-300 px-3 py-2 text-sm text-stone-700 hover:bg-stone-100 disabled:opacity-50"
        >
